;(function ($) {
    ...
    Remodal.prototype.buildDOM = function () {
        ...
        this.modalClose = $("span." + pluginName + "-close");
    ...
    Remodal.prototype.open = function () {
        ...
        this.body.removeClass(pluginName + "_change");
		...
		this.overlay.css("overflow-y","hidden");
        this.overlay.show();
        ...
        setTimeout(function () {
            ...
            setTimeout(function () {
        		...
        		lockScreen();
				self.overlay.css("overflow-y","scroll");
                self.busy = false;
    ...
    Remodal.prototype.change = function () {
        // check if animation is complete
        if (this.busy) {
            return;
        }
        ...
        this.body.addClass(pluginName + "_change");
        var self = this;
        setTimeout(function () {
            self.busy = false;
            self.modal.trigger("changed");
